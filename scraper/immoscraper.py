...
class ImmoCrawler():
    ...
    def __init__(self,city) -> None:
        ...
        """
        self.base_url = "https://www.immoweb.be/en/search/house/for-sale/"
        self.end_url = "/&orderBy=relevance"
        self.mid_url = "/province?countries=BE&page="
        self.links = []
        self.property_data = {}
        self.property_key = 0
        ...
        async def crawl_page(self, session, page, semaphore):
            ...
            async with semaphore:
                ...
                try:
                    ...
                    async with session.get(f"{self.base_url}{self.city}{self.mid_url}{page}{self.end_url}") as response:
